...
def main():
    ...
    # --- 2 quinquies. Import du collecteur ATTRIBUTIONS TED (qui a gagne) -----
    # Levier 1 : recolte les marches attribues en zones a risque et en extrait
    # le titulaire (cible de prospection). Sans LLM, cout zero. Isole : s'il
    # manque ou echoue, il n'empeche jamais le reste du radar de tourner.
    attributions = None
    try:
